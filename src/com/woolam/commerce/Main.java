...
public class Main {
    public static void main(String[] args) {
        ...
        Category electronics = new Category("전자제품", new ArrayList<>());
        Category clothing = new Category("의류", new ArrayList<>());
        Category groceries = new Category("식품", new ArrayList<>());
        ...
        // 상품 생성
        electronics.addProduct(new Product(electronics, "Galaxy S25", 1200000, "최신 스마트폰", 50));
        electronics.addProduct(new Product(electronics, "iPhone 16", 1350000, "Apple의 최신 스마트폰", 50));
        electronics.addProduct(new Product(electronics, "MacBook Pro", 2400000, "M3 칩셋이 탑재된 노트북", 50));
        electronics.addProduct(new Product(electronics, "AirPods Pro", 350000, "노이즈 캔슬링 무선 이어폰", 50));
        ...
        services.put("adminService", adminService);
